...
void CNetGame::Process()
{
    ...
    else
    {
		...
		{                                                     
			...
			//	pPlayer->RemoveFromVehicleAndPutAt(1093.0f, -2036.0f, 90.0f);
			//else
			//	pPlayer->TeleportTo(1093.0f, -2036.0f, 90.0f);
           ...
           // pPlayer->StartJetpack();
									...
									int random = rand() % 11; // рандом авто
		                               ...
		                               case 0: // BMW M5 F90
		                               {
                                                                                 */CVehicle *pVehicleNew = new CVehicle(411, 431.8335, 247.1207, 11.9394, 0.0f, false);
    ...
    while(pkt = m_pRakClient->Receive())
    {
        ...
        switch(packetIdentifier)
        {
            ...
            case ID_CONNECTION_ATTEMPT_FAILED: {
                //pChatWindow->AddDebugMessage("������ �� ��������. ���������������...");
		if(pChatWindow) pChatWindow->AddChatMessage(nullptr, 0xffffffff, "������ �� ��������. ���������������...");
...
void CNetGame::SendChatCommand(const char* szCommand)
{
	...
	pChatWindow->AddChatMessage(nullptr, 0xffffffff, "�� �������� ����� screen.");
