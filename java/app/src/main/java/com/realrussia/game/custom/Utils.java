package com.realrussia.game.custom;
...
public class Utils {
    ...
    public static void ShadowLayout(View view, boolean isAnim) {
        if (view != null) {
    ...
    public static void HideShadowLayout(View view, boolean isAnim) {
        if (view != null) {
            if (isAnim) {
                fadeOut2(view);
                return;
    ...
    private static void fadeIn2(View view) {
        if (view != null) {
            view.animate().setDuration(1250).setListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animation) {
                    super.onAnimationEnd(animation);
                }
            }).alpha(1.0f);
    ...
    private static void fadeOut2(final View view) {
        if (view != null) {
            view.animate().setDuration(1250).setListener(new AnimatorListenerAdapter() {
                public void onAnimationEnd(Animator animation) {
                    view.setVisibility(View.GONE);
